...
template<typename T, typename V> T make_T(V v);
template<> inline __host__ __device__ float  make_T(float v) { return v; }
template<> inline __host__ __device__ float2  make_T(float2 v) { return v; }
template<> inline __host__ __device__ float4  make_T(float3 v) { return make_float4(v, 1); }
template<> inline __host__ __device__ float4  make_T(float4 v) { return v; }
